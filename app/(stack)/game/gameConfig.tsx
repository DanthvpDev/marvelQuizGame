      ...
      <View className="border-2 border-pokeWhite rounded-xl w-11/12 self-center mt-5 py-4 px-3">
        <View className="py-5">
          ...
          <Controller
            ...
            name="level"
          />
          {errors.root?.message && (<Text className="self-center text-lg bg-pokeRed-300 px-2 text-center text-pokeWhite rounded-xl w-10/12 font-Nunito">{errors.root?.message}</Text>)}
