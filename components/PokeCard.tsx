...
export default function PokeCard({ pokemon }: PokeCardProps) {
  return (
    <View className="rounded-xl w-10/12 relative border-2 border-pokeBlue-800 self-center mb-5 overflow-hidden shadow-xl shadow-pokeBlue">
      {/* <Image className="absolute w-full h-full" source={pokeball} /> */}
      <View className="flex flex-col bg-pokeRed-300">
        <View className="items-center h-56 w-full self-center">
          <Image className="h-full w-44" src={pokemon.image.front_shiny} />
        </View>
        <View className="bg-pokeWhite px-2 rounded-t-lg pt-2">
